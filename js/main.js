let elInputSearch = document.querySelector(".films__input-search");
let elFilmsList = document.querySelector(".films__list");
let elPrevButton = document.querySelector(".films__prev-button");
let elNextButton = document.querySelector(".films__next-button");
let elTemplateFilm = document.querySelector(".film__template").content;

let API_KEY = "6556da72";
let search = "hulk";
let page = 1;
...
function renderMovies(arr, node) {
  ...
  arr.forEach((row) => {
    let clonedFilmTemplate = elTemplateFilm.cloneNode(true);
